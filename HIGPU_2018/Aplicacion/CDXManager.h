...
public:
	...
	ID3D11Texture2D * LoadTexture(const char * pszFileName, unsigned long MipMapLevels, ID3D11ShaderResourceView ** ppSRV, float(*pAlphaFunction)(float r, float g, float b), VECTOR4D(*pColorFunction)(const VECTOR4D &Color));
